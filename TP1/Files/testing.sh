...
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 1024-128
printf "      ibuf_size = 1024 :: obuf_size = 128 ..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 128 -I 1024
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
printf "OK.\n"
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 128-1024
printf "      ibuf_size = 128  :: obuf_size = 1024..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 128 -I 1024
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
...
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 4096-1024
printf "      ibuf_size = 4096 :: obuf_size = 1024..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 1024 -I 4096
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
printf "OK.\n"
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 1024-4096
printf "      ibuf_size = 1024 :: obuf_size = 4096..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 4096 -I 1024
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
printf "OK.\n"
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 4096-128
printf "      ibuf_size = 4096 :: obuf_size = 128 ..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 128 -I 4096
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
printf "OK.\n"
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
#test 128-4096
printf "      ibuf_size = 128  :: obuf_size = 4096..."
STARTTIME=$(date +%s)
./tp1 -i TestFiles/stress_test.txt -o TestFiles/stress_out.txt -O 4096 -I 128
ENDTIME=$(date +%s)
diff TestFiles/stress_test_res.txt TestFiles/stress_out.txt
printf "OK.\n"
echo "        Time elapsed: $(($ENDTIME - $STARTTIME))s."
